...
jQuery(document).ready(function($) {
		...
		$("ul.pattern .color2" ).click(function(){
			$("#color-opt").attr("href", "css/colors/light-blue.css" );
			return false;
		});
		
		$("ul.pattern .color3" ).click(function(){
			$("#color-opt").attr("href", "css/colors/deep-purple.css" );
			return false;
		});
		...
		$("ul.pattern .color6" ).click(function(){
			$("#color-opt").attr("href", "css/colors/grey.css" );
			return false;
		});
		...
		$("ul.pattern .color10" ).click(function(){
			$("#color-opt").attr("href", "css/colors/light-brown.css" );
			return false;
		});
		...
		$("ul.bg-pattern .bg1" ).click(function(){
			$("#bg-opt").attr("href", "css/colors/bg1.css" );
			return false;
		});
		$("ul.bg-pattern .bg2" ).click(function(){
			$("#bg-opt").attr("href", "css/colors/bg2.css" );
			return false;
		});
		$("ul.bg-pattern .bg3" ).click(function(){
			$("#bg-opt").attr("href", "css/colors/bg3.css" );
			return false;
		});
		...
		$("ul.bg-pattern li a").click(function(e){
			e.preventDefault();
			$(this).parent().parent().find("a").removeClass("active");
			$(this).addClass("active");
		})
